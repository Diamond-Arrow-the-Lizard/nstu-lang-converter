...
public class LessOperationTextToTokenHandler : ITextToTokenHandler
{
    public bool CanHandle(string word) => word == "<";

    public void Handle(string word, ITokenRepository repo) => repo.AddToken(TokenType.Less, word);
