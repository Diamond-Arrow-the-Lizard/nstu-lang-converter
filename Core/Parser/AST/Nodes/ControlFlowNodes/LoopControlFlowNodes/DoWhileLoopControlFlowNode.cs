...
/// <summary>
/// Represents a do-while loop control flow statement in the Abstract Syntax Tree (AST).
/// Example: "нц <statements> пока <expression> кц".
/// </summary>
public class DoWhileLoopControlFlowNode : IAstNode
{
    /// <summary>
    ...
    public DoWhileLoopControlFlowNode(IAstNode loopExpression, List<IAstNode> body)
    {
