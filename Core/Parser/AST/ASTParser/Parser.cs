...
{
    private List<IToken> _tokens = tokenRepository.GetAllTokens().ToList();
    ...
    public void SetTokensToParser(ITokenRepository tokenRepository) => _tokens = tokenRepository.GetAllTokens().ToList();
